        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            ...
            <div class="col-lg-4 col-6 text-left">
                <form action="">
                    ...
                    <h1 class="ms-auto"><?php echo "ADMIN = " . $_SESSION['Admin']['email'] ; ?></h1>
                </div>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <div class="btn-group w-100" style="position: relative;">
                    <button type="button" class="btn d-flex align-items-center justify-content-between bg-primary w-100 dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="height: 65px; padding: 0 30px;">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/stat" class="nav-item nav-link">statistique</a>
