...
('Jean Levis taille 32', 'Jean bleu foncé, très bon état, porté 5 fois', 25.00, 1, 1),
('Le Petit Prince', 'Édition collector, comme neuf', 15.00, 1, 2),
('Inception DVD', 'Film de Nolan, édition spéciale', 10.00, 1, 3),
('Console PS5', 'Cons   ole en excellent état, avec manette', 350.00, 1, 4),
('MacBook Pro 2019', 'Ordinateur portable, 256Go SSD, 8Go RAM', 800.00, 1, 5);
